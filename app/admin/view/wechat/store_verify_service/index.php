    ...
    <div class="col-sm-12">
        <div class="ibox">
            <div class="ibox-title">
                <button type="button" class="btn btn-w-m btn-primary" onclick="$eb.createModalFrame(this.innerText,'{:Url('create')}')">添加核销员</button>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-striped  table-bordered">
                        ...
                        <tr>
                            ...
                            <th class="text-center">核销员头像</th>
                            <th class="text-center">核销员名称</th>
                        ...
                        <tr>
                            ...
                            <td class="text-center">{$vo.mer_name}</td>
