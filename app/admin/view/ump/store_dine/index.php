    ...
    <div class="layui-row layui-col-space15"  id="app">
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">霸王餐产品搜索</div>
                <div class="layui-card-body">
                    <div class="alert alert-success alert-dismissable">
                        <button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button>
                        目前拥有{$countDine}个霸王餐产品
                    </div>
                    <form class="layui-form">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-inline">
                                <label class="layui-form-label">霸王餐状态：</label>
                                <div class="layui-input-inline">
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">霸王餐产品列表</div>
                <div class="layui-card-body">
                    <table class="layui-hide" id="dineList" lay-filter="dineList"></table>
...
<script>
    ...
    function setTime() {
        setTimeout(function () {
            $eb.axios.get("{:Url('get_dine_id')}").then(function(res){
...
<script>
    layList.form.render();
    layList.tableList('dineList',"{:Url('get_dine_list')}",function () {
        return [
    ...
    layList.tool(function (event,data,obj) {
        switch (event) {
            case 'delstor':
                var url=layList.U({c:'ump.store_dine',a:'delete',q:{id:data.id}});
    ...
    layList.search('export',function(where){
        location.href=layList.U({c:'ump.store_dine',a:'save_excel',q:{status:where.status,store_name:where.store_name}});
    })
