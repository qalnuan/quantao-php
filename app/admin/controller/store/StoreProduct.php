...
class StoreProduct extends AuthController
{
    ...
    public function index()
    {
        ...
        //出售中产品
        $onsale =  ProductModel::where('is_del',0)->where('is_show',1)->where('mer_id',$this->adminId)->count();
        //待上架产品
        $forsale =  ProductModel::where('is_del',0)->where('is_show',0)->where('mer_id',$this->adminId)->count();
        //仓库中产品
