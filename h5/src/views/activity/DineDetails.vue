<template>
  ...
  >
    ...
    <div class="footerRush acea-row row-between-wrapper">
      ...
      <div v-if="!isIn" class="bnt bg-color-red" @click="tapBuy">立即报名</div>
      <div v-else class="bnt bg-color-grey">已报名</div>
    </div>
...
import { getDineDetail, applyDine } from "@api/activity";
// import { postCartAdd } from "@api/store";
import { imageBase64 } from "@api/public";
import { isWeixin } from "@utils/index";
import { openShareAll } from "@libs/wechat";

const NAME = "DineDetails";
