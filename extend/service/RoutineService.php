...
class RoutineService{
    ...
    public static function options(){
        $payment = SystemConfigService::more(['site_url','routine_appId','routine_appsecret','pay_weixin_mchid','pay_weixin_client_cert','pay_weixin_client_key','pay_weixin_key','pay_weixin_open']);
        return $payment;
    }
    ...
    public static function payRoutine($openid,$out_trade_no,$fee,$attach,$body){
        ...
        $mch_id =       self::options()['pay_weixin_mchid'] ? self::options()['pay_weixin_mchid'] : '';
...
//        dump($post_xml);
    ...
    public static function sign($data){
        ...
        $wx_key = self::options()['pay_weixin_key'] ? self::options()['pay_weixin_key'] : '';//申请支付后有给予一个商户账号和密码，登陆后自己设置key
