...
<div id="wrapper">
                ...
                <li class="nav-header">
                    ...
                    <div class="dropdown profile-element admin_open">
                        ...
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            ...
                            <li><a class="J_menuItem admin_close" href="{:Url('system.systemAdmin/adminInfo')}">个人资料</a>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                ...
                                <?php if(isset($child['child']) && count($child['child']) > 0){ ?>
                                    ...
                                    <a href="#">{$child.menu_name} <span class="fa arrow"></span></a>

                                    <ul class="nav nav-third-level">

                                        {volist name="child.child" id="song"}

                                        <li><a class="J_menuItem" href="{$song.url}">{$song.menu_name}</a></li>
                                ...
                                <?php }else{ ?>
                                    ...
                                    <a class="J_menuItem" href="{$child.url}">{$child.menu_name}</a>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="footer"  @touchmove.prevent>
            ...
            <div class="pull-right">&copy; 2014-2018 <a href="http://www.taoyizuan.com/" target="_blank">淘E赚</a>
