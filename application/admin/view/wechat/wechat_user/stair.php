                    ...
                    <table class="table table-striped  table-bordered">
                        ...
                        {volist name="list" id="vo"}
                            <tr>
                                ...
                                <td class="text-center">
                                    <button class="btn btn-info btn-xs" type="button"  onclick="$eb.createModalFrame('编辑','{:Url('user.user/edit',array('uid'=>$vo['uid']))}')"><i class="fa fa-paste"></i> 编辑</button>
                                </td>
                            </tr>
                        {/volist}
                        </tbody>
