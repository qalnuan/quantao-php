<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:65:"C:\Code\Mine\crmeb/application/admin\view\public\edit_content.php";i:1528207198;}*/ ?>
<!doctype html>
...
<body>
<button class="btn btn-success  dim" data-url="<?php echo $action; ?>" type="button"><i class="fa fa-upload"></i>
</button>
