<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:76:"C:\Code\Mine\crmeb/application/admin\view\store\store_coupon_issue\index.php";i:1527060420;s:62:"C:\Code\Mine\crmeb/application/admin\view\public\container.php";i:1527060420;s:63:"C:\Code\Mine\crmeb/application/admin\view\public\frame_head.php";i:1527060420;s:58:"C:\Code\Mine\crmeb/application/admin\view\public\style.php";i:1527060420;s:63:"C:\Code\Mine\crmeb/application/admin\view\public\inner_page.php";i:1527060420;s:65:"C:\Code\Mine\crmeb/application/admin\view\public\frame_footer.php";i:1527060420;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
                    ...
                    <table class="table table-striped  table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <?php if($vo['status'] != '-1'): ?>
                                <button class="btn btn-primary btn-xs" type="button"  onclick="$eb.createModalFrame('修改状态','<?php echo Url('edit',array('id'=>$vo['id'])); ?>',{w:300,h:170})"><i class="fa fa-paste"></i> 修改状态</button>
                                <?php endif; ?>
